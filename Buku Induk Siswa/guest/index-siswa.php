...
<body>
    ...
    <div class="jumbotron" style="border-radius:0px;background-color:#5cb2e8;font-color:white;">
        ...
        <div class="jumbotron" style="border-radius:0px;background-color:#eeebeb;margin-top:-30px;height:80%;font-color:white;"> 
            <h3 style="margin-top:-20px;margin-left:80px;">Data Siswa</h3>
            <table class="table table-bordered" style="width:90%;margin-left:80px" cellpadding="5" cellspacing="0" border="1">
                <tr bgcolor="#CCCCCC">
                    <th>No.</th>
                    <th>NISN</th>
                    <th>Nama Lengkap</th>
